...
class Candy {
    ...
    public static int compareByPrice(Candy c1, Candy c2) {
       ...
       // if (c1.price>c2.price) return c1.price; else return c2.price;
...
public class CandyStore {
    public static void main(String[] args) {
        ...
        Candy[] candies = {candy4, candy3, candy2, candy1};

        System.out.println("Сортировка по имени");
        Arrays.sort(candies, Candy::compareByName);
        Arrays.stream(candies).forEach(Candy::printNameWithPrice /*System.out::println*/);
